...
@WebServlet("/DisplayCoffee")
public class DisplayCoffee extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int loai_id =  Integer.parseInt(req.getParameter("loai_id"));
		String ten_loai = req.getParameter("ten_loai");
		
		List<ThucDon> thucDons = new ArrayList<ThucDon>();
		
		ThucDonDao thucDonDao = new ThucDonDao();
		
		thucDons = thucDonDao.getListByLoaiId(loai_id);
		
		req.setAttribute("listproduce", thucDons);
		req.setAttribute("ten_loai", ten_loai);
